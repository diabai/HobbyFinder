...
import diabai.uw.tacoma.edu.hobbyfinder.authenticate.LogInFragment;
...
public class MainActivity extends AppCompatActivity implements
     ...
     */
    @Override
    public void setUser(User user, String url) {
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                switch (status) {
                    ...
                    case "No such user": //No such user so send over to create an account
                        CreateAccountFragment createAccountFragment = new CreateAccountFragment();
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.fragment_container, createAccountFragment)
                                .addToBackStack(null)
                ...
                Log.w("MainActivity Syncer", "Something wrong with the data: " + e.getMessage());
            }
        }
    }
}